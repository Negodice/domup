...
import { getLocalStorageData, removeFromLocalStorage, setToStorage, StorageItem } from '@/modules/storage'
...
export const loadAuthFormFromStorage = (): AuthFormValues | null => {
	const authFormData = getLocalStorageData()[StorageItem.AuthForm]
